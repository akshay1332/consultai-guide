...
export async function generateReportPDF(report: StoredReport): Promise<void> {
  ...
  const disclaimer = 'This report was generated by ConsultAI Medical System.\nFor any questions, please consult with a healthcare professional.';
  pdf.setFontSize(10);
  const disclaimerLines = pdf.splitTextToSize(disclaimer, contentWidth);
  pdf.text(disclaimerLines, margin, pdf.internal.pageSize.getHeight() - 20, { align: 'center' });
